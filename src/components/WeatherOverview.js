...
const weatherCodeMap = {
  ...
  77: { description: 'Snow grains', icon: 'snowflake.svg' },
  80: { description: 'Slight rain showers', icon: 'showers.svg' },
  81: { description: 'Moderate rain showers', icon: 'showers.svg' },
  82: { description: 'Violent rain showers', icon: 'showers.svg' },
